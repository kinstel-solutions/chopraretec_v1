      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10 h-full flex flex-col justify-end pb-24 md:pb-12">
        <div className="max-w-4xl min-h-[75%] space-y-6 md:space-y-0 text-left">
          ...
          <motion.p
            ...
            <span className="text-primary">Chopra</span> Retec : Trusted for
            Reliability
          </motion.p>
          ...
          <motion.div
            ...
            <Button
              asChild
              className="h-auto w-3/4 md:w-auto py-4 px-8 border-2 border-primary bg-transparent text-white hover:bg-secondary-foreground hover:text-white rounded-none tracking-[0.1em] font-bold text-xs md:text-sm uppercase">
              <Link
                href="/contact"
