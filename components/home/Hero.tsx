...
export function Hero() {
  return (
    <section className="relative h-[100dvh] w-full flex flex-col items-center justify-center overflow-hidden pt-40 md:pt-0">
      ...
      {/* Content */}
      <div className="relative z-10 text-center text-white space-y-8 max-w-5xl px-4 mt-10">
        <motion.div
          ...
          transition={{ duration: 0.8, delay: 0.2 }}
           className="mb-0"
        >
          <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-4 drop-shadow-lg leading-tight">
        ...
        <motion.div
          ...
          className="flex flex-col md:flex-row gap-4 md:gap-8 justify-center items-center text-md font-bold text-gray-300"
        >
